...
import { TEAMS, MEMBERS, getMember, getTeam, membersByTeam } from '../../data';
import { todaysLeaves } from '../../utils/date';
import Avatar from '../../components/Avatar/Avatar';
import Icon from '../../components/Icon/Icon';
import styles from './TeamsAdmin.module.scss';

const PRESET_COLORS = ['#7C8DB5','#C28B8B','#5B8DA8','#6FA890','#B89260','#8B7BAB','#A87B9D','#5F95A8','#7BA08A','#9C8E7E','#C2854A','#FEA32B'];
